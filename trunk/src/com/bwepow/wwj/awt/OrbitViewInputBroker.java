...
*/
/*
 Package refactored to access protected/default members
 */
        ...
        implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener, FocusListener, RenderingListener
{
    ...
    protected Point constrainPointToComponentBounds(int x, int y, Component c)
    {
        if (c != null)
        {
            if (x < 0)
    ...
    protected Position computePositionAtPoint(double mouseX, double mouseY)
    {
    ...
    public void mouseDragged(MouseEvent mouseEvent)
    {
            ...
            || areModifiersExactly(mouseEvent, InputEvent.BUTTON1_DOWN_MASK | InputEvent.CTRL_DOWN_MASK))
        {
            if (mouseMove != null)
            {
                ...
                if (mouseMove.y != 0)
                {
                    //System.out.println("MOUSE_MOVE: " + mouseMove.y);
    ...
    protected void setCenterLatLon(Angle latitude, Angle longitude)
    {
        if (this.view == null)
            return;
    ...
    protected void setCenterPosition(Position newCenter, boolean smoothed, double smoothingAmount)
    {
        if (this.view == null)
            return;
    ...
    protected void setHeading(Angle newHeading)
    {
        if (this.view == null)
            return;
    ...
    protected void setHeading(Angle newHeading, boolean smoothed, double smoothingAmount)
    {
        if (this.view == null)
            return;
    ...
    protected void setPitch(Angle newPitch)
    {
        if (this.view == null)
            return;
    ...
    protected void setPitch(Angle newPitch, boolean smoothed, double smoothingAmount)
    {
        if (this.view == null)
            return;
    ...
    protected void setZoom(double newZoom, boolean smoothed, double smoothingAmount)
    {
        if (this.view == null)
            return;
    ...
    protected Angle computeLatOrLonChange(double amount, boolean slow)
    {
        if (this.wwd == null
                || this.wwd.getModel() == null
                || this.wwd.getModel().getGlobe() == null
    ...
    protected Angle computeNewHeading(double amount, boolean slow)
    {
        if (this.view == null)
            return Angle.ZERO;
    ...
    protected Angle computeNewPitch(double amount, boolean slow)
    {
        if (this.view == null)
            return Angle.ZERO;
    ...
    protected double computeNewZoom(double amount, boolean slow)
    {
        if (this.view == null)
            return 0;
