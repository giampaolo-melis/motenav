        ...
        implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener, FocusListener, InputHandler
{
    ...
    protected OrbitViewInputBroker viewInputBroker = new OrbitViewInputBroker();
    ...
    protected void setViewInputBroker(OrbitViewInputBroker viewInputBroker) {
        this.viewInputBroker = viewInputBroker;
    }
